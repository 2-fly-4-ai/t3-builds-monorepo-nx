      ...
      <div className="col-span-4 mx-auto mt-4">
        <div className="relative col-span-4 ">
          <div
            ...
            className="group absolute flex h-60 w-full transition duration-200 hover:bg-black hover:bg-opacity-20"
          >
            <Link href={`/courses/${slug}`} className="mx-auto my-auto mt-4">
              <button
                onClick={(event) => {
        ...
        <Link href={`/courses/${slug}`} className="">
          <div className="h-60">
            <Image
              src={
                featuredImage ??
