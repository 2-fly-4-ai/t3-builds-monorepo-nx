...
export function TechCard({ post }: TechCardProps) {
  ...
  return (
    <div className="hover:shadow-[0px_0px_5px_5px_rgb(231,229,228)] group grid w-[320px] grid-cols-10 gap-2 gap-x-8 rounded-xl border-2 bg-white bg-opacity-50 p-4 py-4 shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] transition duration-200 dark:border-gray-300  dark:bg-white dark:bg-opacity-10   ">
      ...
      <div className=" col-span-full flex w-full items-center ">
        ...
        <ul className="ml-auto flex flex-wrap items-center gap-2 text-center font-mono font-bold">
          {webUrl && (
            <li className="">
              <a
                href={webUrl}
