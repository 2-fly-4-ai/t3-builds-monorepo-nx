    ...
    <>
      ...
      <section className="container grid justify-center gap-6 py-8 md:py-12 lg:py-24">
        <div className="mx-auto flex flex-col gap-4 md:max-w-[52rem]">
          <h2 className="text-3xl font-bold leading-[1.1] tracking-tighter sm:text-3xl md:text-6xl dark:text-slate-200 text-slate-700">
            Features
          </h2>
          <p className="max-w-[85%] leading-normal text-slate-700 dark:text-slate-400 sm:text-lg sm:leading-7">
