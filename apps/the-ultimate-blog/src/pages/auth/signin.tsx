...
const SigninPage: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className="flex h-full min-h-screen items-center justify-center  px-4 py-12 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="flex w-full flex-col gap-3">
            <Button
              ...
              className="w-full rounded-lg bg-white ring-1 ring-inset ring-gray-300 dark:bg-green-400"
              spinnerVariant="dark"
            >
              Sign in with Google
            </Button>
