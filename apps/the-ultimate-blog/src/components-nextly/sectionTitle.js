...
const SectionTitle = (props) => {
  return (
    <Container
      className={`mt-4 flex w-full flex-col border ${
    ...
    >
      ...
      {props.title && (
        <h2 className="mt-3 max-w-2xl text-3xl font-bold leading-snug tracking-tight text-gray-800 dark:text-white lg:text-5xl lg:leading-tight">
          {props.title}
        </h2>
      )}
