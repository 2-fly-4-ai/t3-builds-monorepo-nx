...
const UnsplahGallary = ({
  ...
  const basePath = router.pathname.split('/')[1].slice(0, -1);
    ...
    onSuccess: () => {
      switch (basePath) {
        ...
        case 'tech':
          ...
          break;
        case 'course':
          utils.post.getCoursePosts.invalidate();
          break;
        case 'discussion':
          utils.post.getLinkPosts.invalidate();
          break;
        case 'product':
          utils.post.getProductPosts.invalidate();
          break;
        default:
  ...
  return (
    ...
    >
      <div className="flex w-full flex-col  items-center justify-center space-y-4">
        ...
        <Tabs defaultValue="upload" className="mr-auto w-full">
          <TabsList>
          ...
          <TabsContent value="upload">
            {' '}
            <div className="relative flex h-80 w-full grid-cols-3 place-items-center justify-center  gap-4 overflow-y-scroll border">
              {selectedImageFile ? (
                <Image
          ...
          <TabsContent value="unsplash">
            <div className="relative grid h-80 w-full grid-cols-3 place-items-center gap-4 overflow-y-scroll border">
