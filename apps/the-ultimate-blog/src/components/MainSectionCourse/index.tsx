...
export default function MainSection({
  ...
  return (
    <main
      ...
      } border-gray min-h-screen  w-full border-r border-gray-200 bg-gray-200   transition-all duration-500  ease-in-out  dark:bg-inherit ${
      ...
      <div
        className={`${
          ...
          showListView
            ...
            : 'custom-animation-switch  xl:grid-cols-3 2xl:grid-cols-4'
        } `}
      >
