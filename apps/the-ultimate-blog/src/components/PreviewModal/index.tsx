...
export default function PreviewModal({ post }: TechFormModalProps) {
              ...
              <TabsContent value="Description">
                <div className="relative ">
                  <div className="flex w-full flex-col gap-8 ">
                      ...
                      <ul className="flex list-outside gap-2  p-0 px-4">
                        {tags?.map((tag, index) => {
                          return (
                            <li
                              key={index}
                              className="m-0 list-outside list-none "
                            >
                              #{tag.name}
                            </li>
                          );
                    ...
                    <div className="w-full  rounded-xl border-2 border-gray-300 p-8 ">
