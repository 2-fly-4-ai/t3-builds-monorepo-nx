  ...
  return (
    ...
    >
        ...
        <div class="overflow-y-auto py-4 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          ...
          >
            <div class="flex justify-between items-center mb-3">
              ...
              <button
                type="button"
                class="inline-flex p-1 w-6 h-6 rounded-lg text-primary-700 bg-primary-50 focus:ring-2 focus:ring-primary-400 hover:bg-primary-100 dark:bg-primary-900 dark:text-primary-300 dark:hover:bg-primary-800 dark:hover:text-primary-200"
            ...
            <a
              href="#"
              class="text-sm font-medium underline text-primary-700 dark:text-primary-300 hover:no-underline"
            >
      ...
      {status === 'authenticated' ? (
        ...
        <div className="flex items-center justify-center gap-4 border col-span-8">
          {/* <div>
          <AiOutlineBell />
        </div>
        <div>
