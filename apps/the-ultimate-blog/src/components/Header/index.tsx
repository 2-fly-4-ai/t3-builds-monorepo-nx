  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center items-center col-span-3">
        <GoThreeBars className="mx-4" onClick={() => setIsOpenSideBar(true)} />
      ...
      >
        <button
          ...
          className="border absolute right-0 px-4 bg-red-300"
        >
          Exit
        </button>
        <div className="overflow-y-auto py-4 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          ...
          <ul className="space-y-2">
            ...
            <li>
              ...
              >
                ...
                <span className="inline-flex justify-center items-center w-5 h-5 text-xs font-semibold text-primary-800 bg-primary-100 rounded-full dark:bg-primary-200 dark:text-primary-800">
                  6
                </span>
              </a>
            </li>
          ...
          <ul className="pt-5 my-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
            <li>
              <a
                href="#"
          ...
          <div
            id="alert-update"
            className="p-4 mb-3 rounded-lg bg-primary-50 dark:bg-primary-900"
            role="alert"
          >
            <div className="flex justify-between items-center mb-3">
              ...
              <button
                type="button"
                className="inline-flex p-1 w-6 h-6 rounded-lg text-primary-700 bg-primary-50 focus:ring-2 focus:ring-primary-400 hover:bg-primary-100 dark:bg-primary-900 dark:text-primary-300 dark:hover:bg-primary-800 dark:hover:text-primary-200"
            ...
            <a
              href="#"
              className="text-sm font-medium underline text-primary-700 dark:text-primary-300 hover:no-underline"
            >
