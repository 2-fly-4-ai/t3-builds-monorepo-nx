...
import TagForm from '../TagFormDiscuss';
...
//FormSchema
export const WriteFormSchemaLink = z.object({
...
export default function WriteFormModal() {
  ...
  const {
    ...
    resolver: zodResolver(WriteFormSchemaLink),
  });

  //Trpc Routes
  const postRoute = trpc.useContext().post;
  const getTags = trpc?.tag?.getLinkTags.useQuery();

  const createPost = trpc.post.createLinkPost.useMutation({
    onSuccess: () => {
